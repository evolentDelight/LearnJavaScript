...
function deepEqual(val1, val2){
  ...
  if(typeof val1 === "object" && typeof val2 === "object"){
    ...
    console.log("\n val1-2Keys.length")
    console.log(val1Keys.length, val2Keys.length)
    if(val1Keys.length === val2Keys.length){//Check if both objects have same properties
      for(let i = 0; i < val1Keys.length; i++){
        console.log("\n val1-2Keys")
        console.log("Key: ", val1Keys[i], val2Keys[i])
        console.log("Boolean: Keys", val1Keys[i] === val2Keys[i])
        console.log("Value: ", val1[val1Keys[i]], val2[val2Keys[i]])
        console.log("Type: ", typeof(val1[val1Keys[i]]), typeof(val2[val2Keys[i]]))
    ...
    console.log("typeof: ", typeof(val1), typeof(val2))
